         ...
         minorLineStyle:(CPTLineStyle *)minorLineStyle majorGridLineStyle:majorGridLineStyle textStyle:(CPTTextStyle *)textStyle
{
    ...
    axis.labelFormatter = [NSNumberFormatter new];
    [axis.labelFormatter setNumberStyle:NSNumberFormatterDecimalStyle];
    [axis.labelFormatter setAllowsFloats:YES];
    [axis.labelFormatter setMaximumFractionDigits:10];
